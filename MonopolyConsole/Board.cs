...
namespace MonopolyConsole
{
    internal class Board
    {
        ...
        public Board()
        {
            ...
            Tiles[22] = new ActionTile(CardType.Chance, cardFactory.GetCard(CardType.Chance));
            ...
            Tiles[33] = new ActionTile(CardType.CommunityChest, cardFactory.GetCard(CardType.CommunityChest));
            ...
            //DarkBlue
            Tiles[36] = new ActionTile(CardType.Chance, cardFactory.GetCard(CardType.Chance));
